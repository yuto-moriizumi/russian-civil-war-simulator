...
3. **Determine worktree path**: Create the worktree in a sibling directory named `../<repo-name>-$ARGUMENTS` (e.g., if current repo is `my-project`, create `../my-project-feature-auth`).
