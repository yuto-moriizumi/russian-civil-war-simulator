...
export type CountryId = 'soviet' | 'white' | 'finland' | 'ukraine' | 'don' | 'fswr' | 'iskolat' | 'dkr' | 'neutral' | 'foreign' | 'germany' | 'bulgaria' | 'poland' | 'austriahungary' | 'romania' | 'greece' | 'ottoman' | 'serbia' | 'albania' | 'persia' | 'ukrainesoviet' | 'balticdutchy' | 'stavropol' | 'lithuania' | 'odessa' | 'terek' | 'taurida' | 'donsoviets' | 'kuban_soviet' | 'mountainassr';
