...
export type CountryId = 'soviet' | 'white' | 'finland' | 'ukraine' | 'don' | 'fswr' | 'iskolat' | 'neutral' | 'foreign' | 'germany' | 'bulgaria' | 'poland' | 'austriahungary' | 'romania' | 'greece' | 'ottoman' | 'serbia' | 'albania' | 'persia' | 'ukrainesoviet';
